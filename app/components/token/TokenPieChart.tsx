...
const TokenPieChartInner = forwardRef<any, TokenPieChartProps>(({ items, hoveredItem, isMobile, onHoveredItemChange }, ref) => {
  ...
  return (
    <div className="chart" ref={chartContainerRef}>
      <Chart type="donut" options={options} series={seriesWithGaps} width={chartSize} height={chartSize} />
